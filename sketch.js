...
function setup() {
	...
	bob2=new bob(340,600,50)
	bob3=new bob(width/2,600,50)
	bob4=new bob(500,600,50)
	bob5=new bob(600,600,50)
	rope1=new rope(bob1.body,roofSprite.body,-120,0)
	rope2=new rope(bob2.body,roofSprite.body,-60,0)
	rope3=new rope(bob3.body,roofSprite.body,0,0)
